...
|
*/
$config['base_url'] = 'http://localhost/nugitech/setl-transport-service-user/';
...
|
*/
$config['encryption_key'] = '@7G#n2Wp!VzX$Ld&Y9oHK4MqCx^Rt8J%TkQ5wP*';
