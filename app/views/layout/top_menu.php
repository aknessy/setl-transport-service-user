...
<header class="tg-header-height tg-header-tu-2-wrap">
                                ...
                                <li>
                                    <a href="#">
                                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.58537 9V15.977H2.5371L2.5371 9V8.97702H2.51412H0.0229779L0.0229779 6.12735H2.51412H2.5371V6.10437V3.8975C2.5371 2.6467 2.90528 1.67868 3.55238 1.02341C4.19947 0.368155 5.12809 0.0229779 6.25425 0.0229779C6.79466 0.0229779 7.34778 0.0717824 7.76599 0.120635C7.97505 0.145056 8.15029 0.169475 8.27324 0.187786C8.33471 0.196941 8.38311 0.204568 8.41612 0.209903L8.44761 0.215073V2.63796H7.22202C6.60193 2.63796 6.19145 2.83282 5.93646 3.13112C5.68203 3.42876 5.58537 3.82594 5.58537 4.22531V6.10437V6.12735H5.60834L8.32802 6.12735L7.89574 8.97702H5.60834H5.58537V9Z" fill="white" stroke="white" stroke-width="0.0459559" />
                                        </svg>
                                    </a>
                                </li>
                                <li>
            ...
            <div class="container-fluid container-1790">
                <div class="row align-items-center">
                    <div class="col-lg-8 col-5">
                        <div class="tgmenu__wrap d-flex align-items-center">
                            <div class="logo flex-auto">
                                <a href="<?=base_url()?>">
                                    <img src="<?=base_url()?>assets/img/logo/logo-green.png" alt="Logo" />
                                </a>
                            </div>
                            <nav class="tgmenu__nav  ml-160 d-none d-xl-block">
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu tgmenu__navbar-wrap-4 d-none d-xl-flex">
                                    <ul class="navigation">
                                        <li>
                                            <a href="#" class="<?=(NULL == $this->uri->segment(1) ? 'active' : '')?>">Home</a>
                                        </li>
                                        <li class="<?=$this->uri->segment(1) == 'booking' ? 'active' : ''?>">
                                            <a href="<?=base_url()?>">Booking</a>
                                        </li>
                                        <?php 
                                        if($this->session->loggedIn == TRUE || NULL != $this->session->loggedInUserID){?>
                                            <li class="<?=($this->uri->segment(1) == 'customer' || $this->uri->segment(2) == 'profile' ? 'active' : '')?>">
                                                <a href="<?=base_url('customer/profile')?>">My Account</a>
                                            </li>
                                        <?php 
                                        }?>                          
                                    </ul>
                    ...
                    <div class="col-lg-4 col-7">
                        <div class="tg-menu-right-action tg-menu-right-action-2 tg-menu-4-right-action d-flex align-items-center justify-content-end">
                            ...
                            <div class="tg-header-btn ml-30 d-none d-sm-block">
                                <?php 
                                    if($this->session->loggedIn == TRUE || NULL != $this->session->loggedInUserID){?>
                                    <a class="tg-btn-header" href="<?=base_url('login/logout')?>">
                                        <span>
                                ...
                                <?php
                                    ...
                                    <a class="tg-btn-header" href="<?=base_url('login')?>">
                                        <span>
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.7 17.2C1.5 17.2 1.3 17.1 1.2 17C1.1 16.8 1 16.7 1 16.5C1 15.1 1.4 13.7 2.1 12.4C2.8 11.2 3.9 10.1 5.1 9.4C4.6 8.8 4.2 8 4 7.2C3.9 6.4 3.9 5.5 4.1 4.8C4.3 4 4.8 3.2 5.3 2.6C5.9 2 6.6 1.5 7.3 1.3C7.9 1.1 8.5 1 9.1 1C9.3 1 9.6 1 9.8 1C10.6 1.1 11.4 1.4 12.1 1.9C12.8 2.4 13.3 3 13.7 3.7C14.1 4.4 14.3 5.2 14.3 6.1C14.3 7.3 13.9 8.5 13.1 9.4C13.7 9.8 14.3 10.2 14.9 10.7C15.7 11.5 16.2 12.3 16.7 13.3C17.1 14.3 17.3 15.3 17.3 16.4C17.3 16.6 17.2 16.8 17.1 16.9C17 17 16.8 17.1 16.6 17.1C16.5 17.1 16.4 17.1 16.3 17C16.2 17 16.1 16.9 16.1 16.8C16 16.7 16 16.7 15.9 16.6C15.9 16.5 15.8 16.4 15.8 16.3C15.8 15.4 15.6 14.6 15.3 13.8C15 13 14.5 12.3 13.8 11.7C13.2 11.2 12.6 10.7 11.9 10.4C11.1 10.9 10.2 11.2 9.1 11.2C8.1 11.2 7.1 10.9 6.3 10.4C5.2 10.9 4.2 11.7 3.5 12.8C2.8 13.9 2.4 15.1 2.4 16.4C2.4 16.6 2.3 16.8 2.2 16.9C2.1 17.1 1.9 17.2 1.7 17.2ZM9.1 2.5C8.4 2.5 7.7 2.7 7.1 3.1C6.4 3.5 6 4.1 5.7 4.7C5.4 5.4 5.3 6.1 5.5 6.9C5.6 7.6 6 8.3 6.5 8.8C7 9.3 7.7 9.7 8.4 9.8C8.6 9.8 8.9 9.9 9.1 9.9C9.6 9.9 10.1 9.8 10.5 9.6C11.2 9.3 11.7 8.9 12.2 8.2C12.6 7.6 12.8 6.9 12.8 6.2C12.8 5.2 12.4 4.3 11.7 3.6C11 2.8 10.1 2.5 9.1 2.5Z" fill="currentColor" />
                                            </svg>
        ...
        <div class="tgmobile__menu">
            <nav class="tgmobile__menu-box">
                ...
                <div class="nav-logo">
                    <a href="index.html"><img src="<?=base_url()?>assets/img/logo/logo-green.png" alt="logo"></a>
                </div>
